...
This script runs all periodontal analysis pipeline steps in sequence.
It can run the full pipeline or individual steps, and supports
...
Usage:
    ...
    # Run specific steps
    python run_pipeline.py --steps 1 2 5
...
Pipeline Steps:
    1. Segmentation (01_segmentation.py)
    2. ROI Generation (02_roi_generation.py)
    3. Registration (03_registration.py) - [NOT YET IMPLEMENTED]
    4. Plasma Processing (04_plasma_processing.py)
    5. PET Quantification (05_pet_quantification.py)
    6. STIR Quantification (06_stir_quantification.py) - [NOT YET IMPLEMENTED]
    7. Validation & QC (07_validation_qc.py)
...
def print_pipeline_overview():
    ...
    print("\n" + "="*70)
    print("PERIODONTAL ANALYSIS PIPELINE")
    print("="*70)
    print("\nAvailable steps:\n")
    ...
    for step_num, step in PIPELINE_STEPS.items():
        ...
        print(f"  {step_num}. [{status}] {step['name']}: {step['description']}{impl_str}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Periodontal Analysis Pipeline Orchestrator',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    python run_pipeline.py                    # Run all implemented steps
    python run_pipeline.py --steps 1 2 5      # Run specific steps
    ...
    if args.steps:
        ...
        # Run all implemented steps by default
        steps_to_run = [n for n, s in PIPELINE_STEPS.items() if s['implemented']]

    # Pipeline header
    logger.info("\n" + "="*70)
    logger.info("PERIODONTAL ANALYSIS PIPELINE")
